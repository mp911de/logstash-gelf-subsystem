...
public class DatenpumpeDefinition extends SimpleResourceDefinition
{
    ...
    private static final AttributeDefinition[] ATTRIBUTES = {Attributes.NAME, Attributes.HOST, Attributes.PORT, Attributes.JNDI_NAME};


    private DatenpumpeDefinition() {
        super(PathElement.pathElement(ModelConstants.DATENPUMPE),
